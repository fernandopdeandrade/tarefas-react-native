  ...
  return (
    <ScrollView>
      ...
      <View style={styles.container}>
        <Text style={{ color: "#069", fontSize: 15, marginTop: 20 }}>
          Insira suas anotações!
        </Text>
        <TextInput
        ...
        <View style={styles.viewHours}>
          <Text>Formato das horas: 00:00</Text>
          <TextInput
        ...
        <View style={styles.viewButtons}>
          <Button title="Ver anotações" onPress={() => toGoBack()} />

          <Button color="green" title="Salvar" onPress={verifyAnotation} />
        </View>
      </View>
      <Footer />
    </ScrollView>
